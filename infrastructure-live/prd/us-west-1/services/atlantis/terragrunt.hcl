...
inputs = {
  ...
  # VPC and Networking (provide existing resources for PRD US-WEST-1)
  vpc_id              = "vpc-prd-us-west-1"  # Replace with your prd us-west-1 VPC ID
  public_subnet_ids   = ["subnet-prd-us-west-1-pub-a", "subnet-prd-us-west-1-pub-b"]  # Replace with your public subnet IDs
  private_subnet_ids  = ["subnet-prd-us-west-1-priv-a", "subnet-prd-us-west-1-priv-b"]  # Replace with your private subnet IDs
