...
inputs = {
  ...
  # VPC and Networking (provide existing resources for STG US-WEST-1)
  vpc_id              = "vpc-stg-us-west-1"  # Replace with your stg us-west-1 VPC ID
  public_subnet_ids   = ["subnet-stg-us-west-1-pub-a", "subnet-stg-us-west-1-pub-b"]  # Replace with your public subnet IDs
  private_subnet_ids  = ["subnet-stg-us-west-1-priv-a", "subnet-stg-us-west-1-priv-b"]  # Replace with your private subnet IDs
