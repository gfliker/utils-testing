...
inputs = {
  ...
  # VPC and Networking (provide existing resources for STG US-EAST-1)
  vpc_id              = "vpc-stg-us-east-1"  # Replace with your stg us-east-1 VPC ID
  public_subnet_ids   = ["subnet-stg-us-east-1-pub-a", "subnet-stg-us-east-1-pub-b"]  # Replace with your public subnet IDs
  private_subnet_ids  = ["subnet-stg-us-east-1-priv-a", "subnet-stg-us-east-1-priv-b"]  # Replace with your private subnet IDs
  
  # Atlantis configuration
  atlantis_image_tag     = "latest"
  github_user           = "your-github-username"  # Change this
  github_token_secret_name = "atlantis/github-token-stg"  # Store in AWS Secrets Manager
  github_webhook_secret_name = "atlantis/webhook-secret-stg"  # Store in AWS Secrets Manager
  repo_allowlist        = "github.com/your-org/*"  # Change this
  
  # ECS configuration - Staging settings (smaller)
  cpu                   = 512   # Smaller for staging
  memory               = 1024   # Smaller for staging
